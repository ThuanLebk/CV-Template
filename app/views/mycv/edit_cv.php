                    ...
                    <div class="infoLines">
                        ...
                        <div id="tel-container">
                            <div class="box">
                                ...
                                <div class="right">
                                    <input type="tel" placeholder="0909888777" name="telNumber" id="telNumber" value="<?= $personalInfo['telNumber'] ?>" required />
                        ...
                        <div id="email-container">
                            <div class="box">
                                ...
                                <div class="right">
                                    <input type="email" placeholder="abc@gmail.com" name="email" id="email" value="<?= $personalInfo['email'] ?>" required />
                        ...
                        <div id="address-container">
                            <div class="box">
                                ...
                                <div class="right">
                                    <textarea class="textarea-fullwidth" name="address" id="address" placeholder="117-119 Lý Chính Thắng, Võ Thị Sáu, Quận 3, Thành phố Hồ Chí Minh" required><?php echo ($personalInfo['address']); ?></textarea>
